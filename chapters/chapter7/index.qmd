...
```{=html}
<pre class="mermaid-js" data-label="fig-example-dag">
flowchart TD
    A[A] --&gt; M[M]
    M --&gt; Y[Y]
    A --&gt; Y
...
**Figure 7.1:** Simple mediation DAG showing direct and indirect paths
...
```{=html}
<pre class="mermaid-js" data-label="fig-M1">
flowchart TD
    X[X] --&gt; M[M]
    M --&gt; Y[Y]
    X --&gt; Y
...
**Figure 7.2:** Mediation DAG showing total effect decomposition into direct and indirect paths
...
```{=html}
<pre class="mermaid-js" data-label="fig-M2">
flowchart TD
    X[X] --&gt;|&quot;β₁&quot;| M[M]
    M --&gt;|&quot;θ₂&quot;| Y[Y]
    X --&gt;|&quot;θ₁&quot;| Y
...
**Figure 7.3:** Mediation DAG with labelled path coefficients from the regression models
...
```{=html}
<pre class="mermaid-js" data-label="fig-Assum">
flowchart TD
    C[C] --&gt; X[X]
    C --&gt; Y[Y]
    X --&gt; M[M]
...
**Figure 7.4:** Mediation DAG with exposure-outcome confounder $C$ and mediator-outcome confounder $Z$
...
```{=html}
<pre class="mermaid-js" data-label="fig-dag-lifestyle">
flowchart TD
    A[A] --&gt; M[M]
    M --&gt; Y[Y]
    A --&gt; Y
...
**Figure 7.5:** DAG for lifestyle intervention mediation
...
```{=html}
<pre class="mermaid-js" data-label="fig-dag-profession">
flowchart TD
    A[A (Professional)] --&gt; M[M (Education)]
    M --&gt; Y[Y (Income)]
    A --&gt; Y
...
**Figure 7.6:** DAG for profession-education-income mediation
