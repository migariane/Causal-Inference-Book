...
![Simple mediation DAG showing direct and indirect paths](figures/fig-example-dag.png){#fig-example-dag}
...
![Mediation DAG showing total effect decomposition into direct and indirect paths](figures/fig-M1.png){#fig-M1}
...
![Mediation DAG with labelled path coefficients from the regression models](figures/fig-M2.png){#fig-M2}
...
![Mediation DAG with exposure-outcome confounder $C$ and mediator-outcome confounder $Z$](figures/fig-Assum.png){#fig-Assum}
...
![DAG for lifestyle intervention mediation](figures/fig-dag-lifestyle.png){#fig-dag-lifestyle}
...
![DAG for profession-education-income mediation](figures/fig-dag-profession.png){#fig-dag-profession}
