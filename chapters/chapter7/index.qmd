...
$$ E(M \mid X=x) = \beta_{0} + \beta_{1}x $$ {#eq-ContMed}

$$ E(Y \mid X=x, M=m) = \theta_{0} + \theta_{1}x + \theta_{2}m $$ {#eq-ContOut}
...
$$ E(M \mid X=x) = \beta_{0} + \beta_{1}x $$ {#eq-ContMed2}

and now a model for the outcome that includes an interaction between the exposure and the mediator

$$ E(Y \mid X=x, M=m) = \theta_{0} + \theta_{1}x + \theta_{2}m + \theta_{3}xm $$ {#eq-ContOutEM}
