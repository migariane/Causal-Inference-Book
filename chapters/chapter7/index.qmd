...
Early proponents of evaluating this model suggested using the "product of coefficients method" (also known as "product method") [@Baron1986]. Let M and Y be continuous variables, consider the following regression models:
$$
