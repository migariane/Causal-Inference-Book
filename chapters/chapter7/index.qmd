...
![Simple mediation DAG showing direct and indirect paths](figures/fig-example-dag.pdf){#fig-example-dag}
...
![Mediation DAG showing total effect decomposition into direct and indirect paths](figures/fig-M1.pdf){#fig-M1}
...
![Mediation DAG with labelled path coefficients from the regression models](figures/fig-M2.pdf){#fig-M2}
...
![Mediation DAG with exposure-outcome confounder $C$ and mediator-outcome confounder $Z$](figures/fig-Assum.pdf){#fig-Assum}
...
![DAG for lifestyle intervention mediation](figures/fig-dag-lifestyle.pdf){#fig-dag-lifestyle}
...
![DAG for profession-education-income mediation](figures/fig-dag-profession.pdf){#fig-dag-profession}
