...
```
::: {.callout-note}
**Box 6.1 (Stata) removed** — For the IPTW computation Stata code, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
Time-varying confounding DAG: $L_1$ is influenced by prior treatment $A_0$ and affects subsequent treatment $A_1$, creating treatment-confounder feedback.
:::
...
```
::: {.callout-note}
**Box 6.2 (Stata) removed** — For the bootstrap IPTW Stata code, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
**Box 6.3 (Stata):** Marginal structural model with stabilized weights
...
```
::: {.callout-note}
**Box 6.4 (Stata) removed** — For the data setup Stata code, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
::: {.callout-note}
**Box 6.5 (Stata) removed** — For the data preparation Stata code, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
**Box 6.6 (Stata):** MSM with stabilized weights
...
```
::: {.callout-note}
**Box 6.7 (Stata) removed** — For this Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
::: {.callout-note}
**Box 6.8 (Stata) removed** — For the LTMLE Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
::: {.callout-note}
**Box 6.10 (Stata) removed** — For the IPCW Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
**Box 6.11 (Stata):** Stata equivalent for Box 6.11
...
```
::: {.callout-note}
**Box 6.13 (Stata) removed** — For the survival TMLE Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
