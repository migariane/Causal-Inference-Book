...
summary(data$sw)
```
**Box 6.5 (Stata):** Stata equivalent for Box 6.5
...
```
**Box 6.6 (Stata):** Stata equivalent for Box 6.6
...
```
**Box 6.9 (Stata):** Stata equivalent
...
```
**Box 6.12 (Stata):** Stata equivalent
...
summary(ltmle_fit)
```
**Box 6.14 (Stata):** Stata equivalent
