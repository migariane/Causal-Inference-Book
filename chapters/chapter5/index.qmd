...
```
::: {.callout-note}
**Box 5.1 (Stata) removed** — For the IPTW-RA Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
::: {.callout-note}
**Box 5.2 (Stata) removed** — For the `teffects ipwra` Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
::: {.callout-note}
**Box 5.3 (Stata) removed** — For the AIPTW by hand Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
::: {.callout-note}
**Box 5.4 (Stata) removed** — For the `teffects aipw` Stata implementation, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
**Box 5.5 (Stata):** TMLE by hand (6 steps)
...
g0W = (-1 / (1-gW))
```
**Box 5.6 (Stata):** TMLE with eltmle command
...
```
::: {.callout-note}
**Box 5.7 (Stata) removed** — For the Monte Carlo simulation Stata code, see the computational tutorial. Full code: [https://github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).
:::
...
```
**Box 5.8 (Stata):** Data setup for TMLE analysis with RHC dataset
...
*Note: For the full Stata workflow including non-parametric G-formula, IPTW, MSM, AIPTW, and TMLE implementations, see the companion tutorial at [github.com/migariane/TutorialComputationalCausalInferenceEstimators](https://github.com/migariane/TutorialComputationalCausalInferenceEstimators).*
...
The `eltmle` Stata package (available at [github.com/migariane/eltmle](https://github.com/migariane/eltmle)) provides a complete implementation of TMLE with Super Learner integration for Stata users. To install:
...
For cross-validated TMLE, use the `cveltmle` option which implements CV-TMLE for improved small-sample performance:
```stata
eltmle Y A W, tmle cveltmle
```
...
**R:** The `tmle3` package provides a modular interface for TMLE and CV-TMLE.

**Stata:** The `eltmle` package ([github.com/migariane/eltmle](https://github.com/migariane/eltmle)) implements TMLE with the `cveltmle` option for cross-validated TMLE:
