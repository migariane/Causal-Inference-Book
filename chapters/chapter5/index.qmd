...
```
**Box 5.1 (Stata):** IPTW with regression adjustment (IPTW-RA)
...
ate_aiptw
```
**Box 5.2 (Stata):** IPTW-RA using teffects
...
```
**Box 5.3 (Stata):** AIPTW estimator by hand with bootstrap
...
```
**Box 5.4 (Stata):** AIPTW using teffects
...
H0W = (-1 / (1 - gW))
```
**Box 5.7 (Stata):** Monte Carlo simulation comparing all methods
