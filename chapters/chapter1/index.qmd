...
![Causal Inference Roadmap as detailed in [@Dang2023].](figures/CI Roadmap.png){#fig-CIroadmap fig-align="center"}
...
![Three types of DAGs: causal fork (confounding), inverted fork (collider), and chain (mediation). Adapted from Luque-Fernandez et al.](figures/Figure1.png){#fig-DAG1 fig-align="center"}
...
To illustrate the induced association of conditioning on a collider, three variables are defined A (unrelated to B), B (unrelated to A), and C (collider, a child of A and B). The association between these variables are shown in @fig-DAG4.

![Collider bias illustration: A and B are marginally independent but become associated when conditioning on their common effect C.](figures/Figure2.png){#fig-DAG4 fig-align="center"}

We now simulate some data for A, B and C and tabulate the data in Tables @tbl-ColliderAB, @tbl-ColliderAC, and @tbl-ColliderBC
